...
var base = Rebase.createClass({
  apiKey: "AIzaSyDiJelqfMFx8daWFUX_KS5vMOiCpIXAdVI",   // replace with your Firebase application's API key
  authDomain: "byebyebuyflix.firebaseapp.com",
  databaseURL: "https://byebyebuyflix.firebaseio.com", // replace with your Firebase application's database URL
})
      ...
      return (
        <div className="map col-sm-12">
          <Gmaps width={'100%'}
                 ...
                 lng={'-87.6285782'}
                 zoom={11}
                 loadingMessage={'Getup and go now!!!'}
